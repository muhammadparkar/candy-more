...
import { PRODUCTS, imgSrc, type Product } from "../data/products";
import { ProductDetailModal } from "./ProductDetailModal";

const FEATURED = [
  "red-rose-heart-stand-bouquet",
  "elegant-indoor-plant-gift",
  "luxury-mixed-bouquet",
  "floral-indulgence",
  "scented-surprises",
  "high-end-modern-tablescape",
          ...
          {FEATURED.map((product) => (
            ...
            >
              <div className="relative aspect-square overflow-hidden rounded-2xl bg-cream">
                ...
                <Image
                  src={imgSrc(product.photo, 800, 800)}
                  alt={product.name}
                  fill
